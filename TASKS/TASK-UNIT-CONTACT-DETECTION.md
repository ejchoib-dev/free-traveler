...
이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 51번 행(`UNIT-CONTACT-DETECTION`, Category=UNIT_TEST)을 실제 개발 가능한 단위로 구체화한 것이다. 제목: **연락처 탐지 단위 테스트**. 근거 문서: `docs/06_SRS_UIUX_REVISED.md`(Requirement 원문), `design-reference/UI_CONTRACT.md`/`design-reference/D-001/DESIGN.md`(디자인 계약).
...
| Screen | Route | Page Entry |
|---|---|---|
| 해당없음 | N/A | `tests/unit/contact-detection.spec.ts` |
...
- 전화번호·이메일·메신저 ID 기준 테스트셋 탐지율 95% 이상
- 오탐 5% 이하
