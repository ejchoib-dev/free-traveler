...
이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 22번 행(`COMP-SCR003-HOTEL`, Category=COMPONENT)을 실제 개발 가능한 단위로 구체화한 것이다. 제목: **숙소 조건 입력·요약·외부 이동**. 근거 문서: `docs/06_SRS_UIUX_REVISED.md`(Requirement 원문), `design-reference/UI_CONTRACT.md`/`design-reference/D-001/DESIGN.md`(디자인 계약).
...
| Screen | Route | Page Entry |
|---|---|---|
| SCR-003 | `/travel-tools` | `src/components/scr003/HotelTab.tsx` |
...
신규 생성: `src/components/scr003/HotelTab.tsx`
...
- Flight Tab과 동일 시각 규칙

## Security/Privacy AC

- **입력값을 서버 DB·서버 로그·분석 이벤트·URL 쿼리에 전달·저장하지 않는다. 전용 API Route를 만들지 않는다.**(REQ-FUNC-025, NF-017)

## Test Cases

- TC-FUNC-019: `REQ-FUNC-019` 수용 기준을 검증(`docs/06_SRS_UIUX_REVISED.md` 해당 행 Acceptance Criteria 참조)
- TC-FUNC-020: `REQ-FUNC-020` 수용 기준을 검증(`docs/06_SRS_UIUX_REVISED.md` 해당 행 Acceptance Criteria 참조)
- TC-FUNC-021: `REQ-FUNC-021` 수용 기준을 검증(`docs/06_SRS_UIUX_REVISED.md` 해당 행 Acceptance Criteria 참조)
- TC-FUNC-022: `REQ-FUNC-022` 수용 기준을 검증(`docs/06_SRS_UIUX_REVISED.md` 해당 행 Acceptance Criteria 참조)
- TC-FUNC-023: `REQ-FUNC-023` 수용 기준을 검증(`docs/06_SRS_UIUX_REVISED.md` 해당 행 Acceptance Criteria 참조)
- TC-FUNC-024: `REQ-FUNC-024` 수용 기준을 검증(`docs/06_SRS_UIUX_REVISED.md` 해당 행 Acceptance Criteria 참조)
- TC-FUNC-025: `REQ-FUNC-025` 수용 기준을 검증(`docs/06_SRS_UIUX_REVISED.md` 해당 행 Acceptance Criteria 참조)
- TC-FUNC-026: `REQ-FUNC-026` 수용 기준을 검증(`docs/06_SRS_UIUX_REVISED.md` 해당 행 Acceptance Criteria 참조)
