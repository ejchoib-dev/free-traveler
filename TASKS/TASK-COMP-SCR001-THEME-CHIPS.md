# COMP-SCR001-THEME-CHIPS — 여행 동기 Chip 목록
...
이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 7번 행(`COMP-SCR001-THEME-CHIPS`, Category=COMPONENT)을 실제 개발 가능한 단위로 구체화한 것이다. 제목: **여행 동기 Chip 목록**. 근거 문서: `docs/06_SRS_UIUX_REVISED.md`(Requirement 원문), `design-reference/UI_CONTRACT.md`/`design-reference/D-001/DESIGN.md`(디자인 계약).
...
| Screen | Route | Page Entry |
|---|---|---|
| SCR-001 | `/` | `src/components/scr001/ThemeChips.tsx` |
...
신규 생성: `src/components/scr001/ThemeChips.tsx`
...
- Chip은 완전 라운드(radius.full)
- 선택 시 코랄 강조(D-001 §5·§21)
