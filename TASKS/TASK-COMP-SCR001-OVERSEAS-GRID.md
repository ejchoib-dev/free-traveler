...
| 항목 | 값 |
|---|---|
| Task ID | `COMP-SCR001-OVERSEAS-GRID` |
| Category | COMPONENT |
...
이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 4번 행(`COMP-SCR001-OVERSEAS-GRID`, Category=COMPONENT)을 실제 개발 가능한 단위로 구체화한 것이다. 제목: **해외 여행지 카드 그리드**. 근거 문서: `docs/06_SRS_UIUX_REVISED.md`(Requirement 원문), `design-reference/UI_CONTRACT.md`/`design-reference/D-001/DESIGN.md`(디자인 계약).
...
REQ-FUNC-001, REQ-FUNC-005, REQ-FUNC-006, REQ-NF-006, REQ-NF-026

## Screen / Route / Page Entry

| Screen | Route | Page Entry |
|---|---|---|
| SCR-001 | `/` | `src/components/scr001/OverseasGrid.tsx` |
...
신규 생성: `src/components/scr001/OverseasGrid.tsx`
...
- 해외 여행지 6개 카드
- 각 카드 "안전정보 보기" 링크가 국가 코드로 정확히 연결

## Visual AC

- Domestic Grid와 동일 시각 규칙
