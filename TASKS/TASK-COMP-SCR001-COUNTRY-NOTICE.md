...
| 항목 | 값 |
|---|---|
| Task ID | `COMP-SCR001-COUNTRY-NOTICE` |
| Category | COMPONENT |
...
이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 8번 행(`COMP-SCR001-COUNTRY-NOTICE`, Category=COMPONENT)을 실제 개발 가능한 단위로 구체화한 것이다. 제목: **국가별 주의사항 카드**. 근거 문서: `docs/06_SRS_UIUX_REVISED.md`(Requirement 원문), `design-reference/UI_CONTRACT.md`/`design-reference/D-001/DESIGN.md`(디자인 계약).
...
| Screen | Route | Page Entry |
|---|---|---|
| SCR-001 | `/` | `src/components/scr001/CountryNoticeGrid.tsx` |
...
DATA-SAFETY, COMP-SCR001-SAFETY-DRAWER

## Expected Files

신규 생성: `src/components/scr001/CountryNoticeGrid.tsx`
...
- 국가 카드 6개
- 경보 단계 라벨+최종 확인일 배지+7일 경과 경고 배지, "주의사항 보기"로 안전정보 Drawer 오픈

## Visual AC

- Domestic/Overseas Grid와 동일 카드 시각 규칙
