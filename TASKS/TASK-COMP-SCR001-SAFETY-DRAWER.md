...
| 항목 | 값 |
|---|---|
| Task ID | `COMP-SCR001-SAFETY-DRAWER` |
| Category | COMPONENT |
...
이 Task는 `TASKS/00_TASK_LIST.md`의 Seq 6번 행(`COMP-SCR001-SAFETY-DRAWER`, Category=COMPONENT)을 실제 개발 가능한 단위로 구체화한 것이다. 제목: **국가 안전정보 Drawer**. 근거 문서: `docs/06_SRS_UIUX_REVISED.md`(Requirement 원문), `design-reference/UI_CONTRACT.md`/`design-reference/D-001/DESIGN.md`(디자인 계약).
...
REQ-FUNC-047, REQ-FUNC-048, REQ-FUNC-049, REQ-FUNC-050, REQ-FUNC-053, REQ-FUNC-054

## Screen / Route / Page Entry

| Screen | Route | Page Entry |
|---|---|---|
| SCR-001 | `/` | `src/components/scr001/SafetyDrawer.tsx` |
...
신규 생성: `src/components/scr001/SafetyDrawer.tsx`
...
- 8개 필수 카테고리
- 출처·확인일
- 외교부 원문 링크(새 탭, noopener), 7일 초과 stale 경고
- 긴급연락처
- 공식 판단 대체 아님 고지
...
- TC-FUNC-049: `REQ-FUNC-049` 수용 기준을 검증(`docs/06_SRS_UIUX_REVISED.md` 해당 행 Acceptance Criteria 참조)
...
- 추가 검증: UNIT 없음 / E2E-PUBLIC-SMOKE에서 이 Task의 결과를 다시 확인

## Verify

UNIT 없음 / E2E-PUBLIC-SMOKE
